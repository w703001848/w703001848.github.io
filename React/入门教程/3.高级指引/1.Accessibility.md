...
[![选中的链接被蓝色键盘焦点轮廓包围着。](https://react.docschina.org/static/dec0e6bcc1f882baf76ebc860d4f04e5/4fcfe/keyboard-focus.png)](https://react.docschina.org/static/dec0e6bcc1f882baf76ebc860d4f04e5/4fcfe/keyboard-focus.png)
...
![一个切换按钮可以打开一个弹窗，这个弹窗使用了外部点击模式，此图用一个鼠标指针展示了关闭操作是可行的。](..\img\outerclick-with-mouse.gif)
...
![一个通过按钮打开的使用了外部点击模式的弹窗列表。用键盘操作时，我们可以看到弹窗没有在失去焦点时被关闭，遮挡了屏幕上的其他元素。](../img/outerclick-with-keyboard.gif)
...
![一个针对鼠标和键盘用户都正确关闭的弹窗。](../img/blur-popover-close.gif)
